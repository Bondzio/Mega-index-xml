...
// pre_print_r($tmp_glob_arr['oberBegriff'][3]['unterBegriff']);
// pre_print_r($tmp_glob_arr['oberBegriff'][3]['unterBegriff'][0]['uname']);
// pre_print_r($tmp_glob_arr['oberBegriff'][3]['unterBegriff'][1]['uname']);
// pre_print_r($tmp_glob_arr['oberBegriff'][4]['unterBegriff']['uname']);
// pre_print_r($tmp_glob_arr['oberBegriff'][4]);
// pre_print_r($tmp_glob_arr['oberBegriff'][3]);

// pre_print_r($tmp_glob_arr['oberBegriff'][0]['unterBegriff'][6]['uname']);


foreach ($tmp_glob_arr as $ober_key => $ober_value) {
// foreach ($tmp_glob_arr as $oberBegriff) {
